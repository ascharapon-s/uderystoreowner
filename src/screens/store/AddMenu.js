...
export default class UselessTextInput extends Component {
  constructor(props) {
    super(props);
    this.state = { name: 'ชื่อเมนู', price: 'ราคา' };
  }
  ...
  render() {
    return (
      ...
      <View style={{ height: 40, backgroundColor: '#F6B749', justifyContent: 'center' }}>
          <Text style={{ fontSize: 20, marginLeft: 15, color: 'white' }}>เพิ่มเมนูอาหาร</Text>
      </View>
      ...
      <Button block
            onPress={() => { this.addMenuItem(); Actions.menu(); }}
            style={{ marginTop: 40, marginBottom: 30, backgroundColor: '#F6B749' }} >
            <Text>Add This Menu</Text>
      </Button>
      </View>
      </Container>
    );
